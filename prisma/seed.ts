...
async function main() {
  ...
  const products: P[] = [
    ...
    { name: "Ceramic Candle Trio", sku: "FRG-CAN-005", brand: "Aura", category: "Fragrance", room: "Living Room", price: 7900, cost: 3000, stock: 210, max: 250, rating: 4, reviews: 74, sales: 420, badges: ["GIFT_IDEA", "ECO"], image: "1602874801006-e26c4c5b5e8a", material: "Ceramic, soy wax", colour: "Cream", style: "Coastal", desc: "Three hand-poured soy candles in signature scents. Beautifully boxed — ready to gift.", collections: ["gifts-under-100", "best-sellers"] },
    ...
    { name: "Noir Diffuser Set", sku: "FRG-DIF-011", brand: "Aura", category: "Fragrance", room: "Bathroom", price: 8900, cost: 3400, stock: 64, max: 120, rating: 5, reviews: 52, sales: 60, badges: ["GIFT_IDEA"], image: "1602874801006-e26c4c5b5e8a", material: "Glass, reeds", colour: "Smoke", style: "Minimalist", desc: "A slow-release reed diffuser in our signature noir scent. Up to 12 weeks of fragrance.", collections: ["gifts-under-100"] },
